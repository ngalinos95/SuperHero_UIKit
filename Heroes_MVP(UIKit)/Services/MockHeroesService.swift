    ...
    func getSuperHero(id: String) -> PromiseKit.Promise<SuperHero> {
        ...
        if Int(id)! >= 0 && Int(id)! <= 731 {
            ...
            let mockHero = SuperHero(id: id, name: "Boom-Boom", image: Image(url: "https://www.superherodb.com/pictures2/portraits/10/100/400.jpg"), biography: Bio(fullName: "Tabitha Smith", alterEgos: "Meltdown", aliases:  [
                ...
                "Mutate #35",
                "Nancy Forrester"
            ], placeOfBirth: "-", firstAppearance: "Secret Wars II #5", publisher: "Meltdown", alignment: "good"), powerstats: Powerstats(intelligence: "38", strength: "10", speed: "12", durability: "42", power: "57", combat: "64"))
